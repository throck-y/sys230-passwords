    ...
    * remove_pass: Removes a password for the user
    ...
    def create_interfaces(self):
        ...
        while not self.authenticated:
            ...
            self.manager = Data_Manager(DataFrame(columns=["username", "password"]))
            self.authenticated = True
    ...
    def retrieve_pass(self, prompt="view"):
        if self.authenticated:
            ...
            result = self.manager.__retrieve__(username)
    ...
    def add_pass(self, custom=True):
        if self.authenticated:
            ...
            self.manager.__add__(username, password)
            self.update_pass_csv()
    ...
    def remove_pass(self):
        if self.authenticated:
            ...
            if choice == "Y":
                self.manager.__remove__(username)
                self.update_pass_csv()
